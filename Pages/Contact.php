...
<div class="block" style="height: 300px; margin-top: 20px;">
  ...
  <div class="row" style="height: 250px">
    ...
    <h5 class="card-title">John Smith</h5>
      <p class="card-text">As the Owner of Infiltrate Pro founded in 2022, John is dedicated to driving the company's growth and ensuring exceptional customer satisfaction. He leads the team with a clear vision and a passion for innovation.  He is currently 31 years old and enjoys hanging out with his dog Finley</p>
      <small class="text">Position&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Owner</small><br>
      <small class="text">Email&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;owner@email.com</small><br>
      <small class="text">Phone&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;09 812 0001</small><br>
      <button type="button" class="btn btn-info my-2 my-sm-0" id="NavButton" data-toggle="modal" data-target="#hintModal" style="
    width: 100px;
    height: 30px;
    text-align: center;
    line-height: 0px; 
